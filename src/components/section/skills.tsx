      ...
      <div id="skill" className="mt-6">
        <div className="flex flex-col gap-6 md:flex-row md:gap-12">
          <m.div
            ...
            className="relative flex h-max max-h-[260px] flex-1 flex-col justify-between gap-4 overflow-hidden rounded-md border bg-card/80 p-4"
          >
            <div className="flex flex-row items-center gap-3">
              <CodeXml className="h-6 w-6 shrink-0 text-primary" />
          ...
          <m.div
            variants={{ hidden: { opacity: 0, y: -20 }, show: { opacity: 1, y: 0 } }}
            transition={{ easings: easeOutquad }}
            className="flex max-h-[260px] flex-1 flex-col gap-4 overflow-hidden rounded-md border bg-card/80 p-4"
          >
            ...
            <div className="text-sm sm:text-base">
              ...
              <TooltipProvider delayDuration={300}>
                <Tooltip>
                  <TooltipTrigger className="mx-1 underline decoration-primary decoration-2">
                    technologies
                  </TooltipTrigger>
                  <TooltipContent sideOffset={8} className="bg-card/90">
                    <p className="px-1 text-xs text-foreground">
                      Yes, they are
