...
banner: https://res.cloudinary.com/dpegakmzh/image/upload/v1745592797/yogyy/notflox-cover.webp
url: https://notflox.vercel.app/
techs: NextJS, Tailwind, ShadcnUI, MongoDB, ReactQuery
...
<div className="not-prose mt-2">
  <TechMdx techs={['nextjs', 'tailwindcss', 'shadcnui', 'mongodb', 'reactquery']} />
</div>
