...
banner: https://res.cloudinary.com/dpegakmzh/image/upload/yogyy/burbir-cover.webp
url: https://burungbiru.vercel.app
techs: NextJS, Tailwind, ShadcnUI, ReactQuery, Upstash
...
<div className="not-prose mt-2">
  <TechMdx techs={['nextjs', 'tailwindcss', 'shadcnui', 'reactquery', 'upstash']} />
</div>
